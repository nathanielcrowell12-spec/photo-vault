...
export function OrphanProtocolSection() {
  return (
    <section className="py-16 md:py-24" aria-label="Orphan Protocol">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="mt-8 text-left bg-card/90 backdrop-blur-sm rounded-lg border border-border p-6 sm:p-8">
