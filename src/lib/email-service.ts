  ...
  async sendMonthlyReport(data: EmailReportData): Promise<boolean> {
    ...
    try {
      await this.transporter.sendMail({
        from: '"PhotoVault Team" <reports@photovault.com>',
        to: data.to,
        subject,
        text: textContent,
        html: htmlContent,
    ...
    <body>
        ...
        <div class="content">
            ...
            <div style="text-align: center;">
                <a href="https://photovault.com/photographers/revenue" class="cta-button">View Detailed Dashboard</a>
            </div>
  ...
  private generateQuarterlyReportHTML(data: EmailReportData): string {
    ...
    <body>
        ...
        <div class="content">
            ...
            <div style="text-align: center;">
                <a href="https://photovault.com/photographers/analytics" class="cta-button">View Analytics Dashboard</a>
            </div>
  ...
  private generateYearlyReportHTML(data: EmailReportData): string {
    ...
    <body>
        ...
        <div class="content">
            ...
            <div style="text-align: center;">
                <a href="https://photovault.com/photographers/analytics" class="cta-button">View Full Analytics</a>
            </div>
...
View your detailed dashboard: https://photovault.com/photographers/revenue
...
View your analytics dashboard: https://photovault.com/photographers/analytics
...
View your full analytics: https://photovault.com/photographers/analytics
