...
// ==========================================
// SHARE LINK EVENTS
// Server-side tracking for share link feature
// ==========================================

export interface ShareLinkCreatedEvent extends AuthenticatedEventProperties {
  gallery_id: string
  photographer_id: string
...
export interface ShareLinkAccessedEvent extends BaseEventProperties {
  gallery_id: string
  share_link_id: string
  is_valid: boolean
}

export interface ShareLinkRevokedEvent extends AuthenticatedEventProperties {
  gallery_id: string
  share_link_id: string
}

export interface ShareLinkDownloadTrackedEvent extends BaseEventProperties {
  gallery_id: string
  share_link_id: string
...
export type EventPropertiesMap = {
  ...
  [EVENTS.SHARE_LINK_CREATED]: ShareLinkCreatedEvent
  [EVENTS.SHARE_LINK_ACCESSED]: ShareLinkAccessedEvent
  [EVENTS.SHARE_LINK_REVOKED]: ShareLinkRevokedEvent
  [EVENTS.SHARE_LINK_DOWNLOAD_TRACKED]: ShareLinkDownloadTrackedEvent
}
