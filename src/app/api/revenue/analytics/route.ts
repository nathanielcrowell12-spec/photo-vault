...
export async function GET(request: NextRequest) {
  try {
    ...
    if (commissionError) {
      logger.error('[RevenueAnalytics] Error fetching commission payments:', commissionError)
      return NextResponse.json(
    ...
    if (clientError) {
      logger.error('[RevenueAnalytics] Error fetching client payments:', clientError)
      return NextResponse.json(
    ...
    logger.error('[RevenueAnalytics] Revenue analytics error:', error)
    return NextResponse.json(
